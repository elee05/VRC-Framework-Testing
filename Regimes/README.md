...
# Theory
To validate the paper's initial claim, this folder looks at historical returns of the SPX(visible states) and identifies 3 levels of volatiliy(hidden states) \ Still assuming a market behavior following a 3-state Hidden Markov Model and the following:
